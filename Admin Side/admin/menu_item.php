       ...
       <div class="content">
		<div class="page-header-title">
		 ...
		 <div class="page-content-wrapper ">
			...
			<span class="glyphicon glyphicon-plus"></span> Add Menu Items</button>
		...
		<table id="employee_grid" class="table table-bordered table-hover" width="60%" cellspacing="0" data-toggle="bootgrid">
			...
			<thead>
				<tr>
					...
					<th data-column-id="mname">Item Name</th>
          <th data-column-id="mtype">Type</th>
					<th data-column-id="mprice">Price</th>
           <th data-column-id="mdesc">Description</th>
				   
					<th data-column-id="mimage" data-formatter="image"> Image </th>
...
<div id="edit_model" class="modal fade">
    <div class="modal-dialog modal-lg zoomIn  animated">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Edit Menu Items</h4>
            </div>
            <div class="modal-body">
	...
	var grid = $("#employee_grid").bootgrid({
		...
		formatters: {
            ...
            "image":function(column,row){
               ...
               return "<a target='_blank' href='"+row.mimage+"'><img width='100' src='"+row.mimage+"'/></a>";
...
console.log(g_id);
  ...
  $("#user_edit").load("php/menu/menu_edit.php?id="+idd);       
    ...
    }).end().find(".command-delete").on("click", function(e)
    {
		...
		var conf = confirm('Delete ' + $(this).data("row-id") + ' items?');
					//alert(conf);
                    if(conf){
                                $.post('php/menu/menu.php', { id: $(this).data("row-id"), action:'delete'}
                                    , function(){
            ...
            if ($.browser.msie && parseFloat(jQuery.browser.version) <= 9.0) {
                ...
                if (typeof (FileReader) != "undefined") {
                    ...
                    image.onload = function () {
                        ...
                        if (height > 120 || width > 105) {

                            alert("Invalid  image size . Image size should be 120 X 105 pixcel");
                            return false;
